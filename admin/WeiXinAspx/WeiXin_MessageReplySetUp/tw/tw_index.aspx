<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tw_index.aspx.cs" Inherits="WeiXinAspx_WeiXin_MessageReplySetUp_tw_tw_index" %>
...
<script type="text/javascript">
    ...
    WeiXin_MessageReplySetUpgrid.load({ LX: 'TW' });
     ...
     function add() {
          mini.open({
          url: "../WeiXinAspx/WeiXin_MessageReplySetUp/tw/Edit.aspx",//此处注意修改
          title: "新增-图文信息", width: 450, height: 300,
          onload: function() {
      ...
      if (row) {
          mini.open({
              url:"../WeiXinAspx/WeiXin_MessageReplySetUp/tw/Edit.aspx",
              title: "修改-图文信息", width: 450, height: 300,
              onload: function() {
                  var iframe = this.getIFrameEl();
