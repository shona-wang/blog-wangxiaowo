<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="WeiXinAspx_WeiXin_MessageReplySetUp_tw_Edit" %>
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <body>
 <form id="form1">
   <table style="text-align: right; width: 431px;">
    <tr>
    ...
    <td style="text-align:right;">描述</td>
     <td style="text-align:left;"><input id="MessagDescription" name="MessagDescription" class="mini-textbox" required="true"/></td>
    </tr>
    <tr>
  
    <td style="text-align:right;">链接地址</td>
     <td style="text-align:left;"><input id="Url" name="Url" class="mini-textbox" required="true"/></td>
    </tr>
 <tr>
     ...
     <td style="text-align:left;">
         <input id="fileupload1" class="mini-fileupload" name="Fdata" flashurl="../../../swfupload/swfupload.swf"
                ...
                <a class="mini-button" id="A2" iconcls="icon-upload" onclick="onFileSelect()">
         上传</a>
     </td>
    </tr>
    <tr>
    ...
    <tr>
     <td colspan="2" style="text-align: center;">
       <a class="mini-button" iconcls="icon-save" onclick="SaveData">保存</a> <a class="mini-button"
        ...
        <input id="MessageType" name="MessageType" class="mini-hidden" value="TW"/>
     </td>
     </tr>
   </table>
 </form>
