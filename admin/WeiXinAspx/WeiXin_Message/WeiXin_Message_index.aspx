 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeiXin_Message_Index.aspx.cs" Inherits="WeiXinAspx_WeiXin_Message_WeiXin_Message_index" %>
 ...
 <script type="text/javascript">
    ...
    WeiXin_Messagegrid.load();
     ...
     function add() {
          mini.open({
          url: "../WeiXinAspx/WeiXin_Message/WeiXin_Message_Edit.aspx",//此处注意修改
          ...
          ondestroy: function(action) {
              WeiXin_Messagegrid.reload();
          }
     });
    }
      //修改
      function edit() {
      var row =WeiXin_Messagegrid.getSelected();
      if (row) {
          mini.open({
              url:"../WeiXinAspx/WeiXin_Message/WeiXin_Message_Edit.aspx",
     ...
     //删除
     function dels() {
     var rows = WeiXin_Messagegrid.getSelecteds();
     if (rows.length > 0) {
         ...
         function(action) {
             if (action =="ok") {
                 ...
                 var id = ids.join(',');
                 WeiXin_Messagegrid.loading("操作中，请稍后......");
                 $.ajax({
                     url: "WeiXin_Message_Edit.aspx?method=WeiXin_Message_Deletes&&DJBH=" + id,//此处需要手动调整
