 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeiXin_MessageXml_Index.aspx.cs" Inherits="WeiXinAspx_WeiXin_MessageXml_WeiXin_MessageXml_index" %>
  ...
  <div class="mini-fit">
    <div id="WeiXin_MessageXmldatagrid" class="mini-datagrid" style="height: 98%;" url="WeiXin_MessageXmlData.aspx?method=WeiXin_MessageXml_PageJson_SelectWhere" idfield="ID" allowresize="true" pagesize="100" allowcellselect="true" multiselect="true">
      <div property="columns">
        ...
        <div field="MessageDateTime"  width="120" headeralign="center" allowsort="true"  dateFormat="yyyy-MM-dd">
        XXXX
        </div>
      </div>
    </div>
 ...
 <script type="text/javascript">
    ...
    WeiXin_MessageXmlgrid.load();
     ...
     function add() {
          mini.open({
          url: "../WeiXinAspx/WeiXin_MessageXml/WeiXin_MessageXml_Edit.aspx",//此处注意修改
          ...
          ondestroy: function(action) {
              WeiXin_MessageXmlgrid.reload();
          }
     });
    }
      //修改
      function edit() {
      var row =WeiXin_MessageXmlgrid.getSelected();
      if (row) {
          mini.open({
              url:"../WeiXinAspx/WeiXin_MessageXml/WeiXin_MessageXml_Edit.aspx",
     ...
     //删除
     function dels() {
     var rows = WeiXin_MessageXmlgrid.getSelecteds();
     if (rows.length > 0) {
         ...
         function(action) {
             if (action =="ok") {
                 ...
                 var id = ids.join(',');
                 WeiXin_MessageXmlgrid.loading("操作中，请稍后......");
                 $.ajax({
                     url: "WeiXin_MessageXml_Edit.aspx?method=WeiXin_MessageXml_Deletes&&DJBH=" + id,//此处需要手动调整
