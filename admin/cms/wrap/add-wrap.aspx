<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-wrap.aspx.cs" Inherits="cms_wrap_add_wrap" %>
...
<body>
    ...
    <input id="typeid" name="typeid" class="mini-hidden" />
    <fieldset>
        <legend>标题信息</legend>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <textarea id="description" name="description" class="mini-textarea" style="width: 419px;"  ></textarea>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <input class="mini-textbox" name="img" id="img"/>
            ...
            <tr>
                ...
                <td>
                    <div id="targetid" name="targetid" class="mini-checkboxlist" repeatItems="3" repeatLayout="table"
                        textField="name" valueField="id"
                        url="../service/wrap_target.aspx?method=query" >
                    </div>
                </td>
            </tr>
        </table>
...
<script>
    ...
    function SetData(data) {
        ...
        if (data.action == "add") {
            mini.get("typeid").setValue(data.typeid);
        }
        if (data.action == "edit") {
            $.ajax({
                url: "../service/wrap.aspx?method=query&id=" + data.id,
                cache: false,
    ...
    //    mini.get("img").setValue(e.serverData);
    //    mini.alert("上传成功！");
    //}
    ...
    function onOk() {
        ...
        var targetid = mini.get("targetid").getValue();
        ...
        $.ajax({
            url: "../service/wrap.aspx?method=insert",
            data: {
                "data": json
            },
            type: 'post',
