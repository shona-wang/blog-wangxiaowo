...
public partial class cms_service_column_content : System.Web.UI.Page
{
    #region---Page_Load---
    ...
    public void query()
    {
        ...
        {
            json = cmsCommonData.BLL.Db_blog_column_content_BLL.Db_blog_column_content_PageJson_SelectWhere(_namevalue);
        }
        else
        {
            ...
            if (where != "")
            {
                json = cmsCommonData.BLL.Db_blog_column_content_BLL.Db_blog_column_content_Json_getSelectWhere(where);
            }
        }
        if (json == null)
        {
    ...
    public void update()
    {
        ...
        int i = cmsCommonData.BLL.Db_blog_column_content_BLL.Db_blog_column_content_Insert(_namevalue);
    ...
    public void delete()
    {
        ...
        if (where != "")
        {
            i = cmsCommonData.BLL.Db_blog_column_content_BLL.Db_blog_column_content_Delete(where);
        }
        MyPublicMin.WriteStr(i.ToString());
    }
    ...
    public void deletes()
    {
        ...
        int i = cmsCommonData.BLL.Db_blog_column_content_BLL.Db_blog_column_content_Deletes(_namevalue["ids"].ToString());
        MyPublicMin.WriteStr(i.ToString());
    }
