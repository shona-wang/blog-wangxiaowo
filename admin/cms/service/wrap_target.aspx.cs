...
public partial class cms_service_wrap_target : System.Web.UI.Page
{
    #region---Page_Load---
    ...
    public void query()
    {
        ...
        {
            json = cmsCommonData.BLL.Db_blog_wrap_target_BLL.Db_blog_wrap_target_PageJson_SelectWhere(_namevalue);
        }
        else
        {
            ...
            if (where != "")
            {
                json = cmsCommonData.BLL.Db_blog_wrap_target_BLL.Db_blog_wrap_target_Json_getSelectWhere(where);
            }
        }
        if (json == null)
        {
    ...
    public void update()
    {
        ...
        int i = cmsCommonData.BLL.Db_blog_wrap_target_BLL.Db_blog_wrap_target_Insert(_namevalue);
    ...
    public void delete()
    {
        ...
        if (where != "")
        {
            i = cmsCommonData.BLL.Db_blog_wrap_target_BLL.Db_blog_wrap_target_Delete(where);
        }
        MyPublicMin.WriteStr(i.ToString());
    }
    ...
    public void deletes()
    {
        ...
        int i = cmsCommonData.BLL.Db_blog_wrap_target_BLL.Db_blog_wrap_target_Deletes(_namevalue["ids"].ToString());
        MyPublicMin.WriteStr(i.ToString());
    }
