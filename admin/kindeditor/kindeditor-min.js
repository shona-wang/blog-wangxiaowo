...
(function(A, o) {
    ...
    function ha(a, b, c) {
        ...
        function() {
            ...
            function(b, c) {
                ...
                var e = v[d][b];
                if (e && e.length > 0) {
                    c === o ? (wa(a, b, e[0]), delete v[d][b]) : (m(e,
                    function(a, b) {
    ...
    function H(a) {
        for (var b = {},
        c = /\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g, d; d = c.exec(a); ) {
    ...
    function ia(a, b, c, d) {
        ...
        if (d === o) var h = location.pathname.match(/^(\/.*)\//),
        d = h ? h[1] : "";
        var f;
        if (f = /^(\w+:\/\/[^\/]*)/.exec(a)) {
            if (f[1] !== c) return a
    ...
    function S(a, b, c, d, e) {
        ...
        n, r, p, I, o, j) {
            ...
            if (kb[l] && !Ha[l]) if (d) {
                ...
                j = n = "\n";
                I = 0;
                for (o = r ? f.length : f.length - 1; I < o; I++) n += e,
                r || (j += e);
                p ? f.pop() : r || (j += e)
            } else n = j = "";
            if (J !== "") {
                ...
                function(a, d) {
                    Sb[a] && (w[a] = a);
                    N(a, ["src", "href"]) >= 0 && (w[a] = ia(d, c)); (b && a !== "style" && !h[l]["*"] && !h[l][a] || l === "body" && a === "contenteditable" || /^kindeditor_\d+$/.test(a)) && delete w[a];
                    if (a === "style" && d !== "") {
                        var e = aa(d);
                        m(e,
                        function(a) {
    ...
    function za(a, b) {
        ...
        function e(a, b, c) {
            var e = []; (a = (c.ownerDocument || c).getElementById(a.replace(/\\/g, ""))) && d(b, a.nodeName) && xa(c, a) && e.push(a);
            return e
        }
        function g(a, b, c) {
        ...
        function h(a, b, d, e) {
            ...
            e.nodeType == 1 && (b === null ? ya(e, a) !== null && g.push(e) : b === c(ya(e, a)) && g.push(e));
            return g
        }
        function f(a, b) {
            var c = [],
            ...
            h(i[1].toLowerCase(), null, k, b);
                ...
                if (c === "id") k = e(i, k, b);
                    ...
                    for (var n, p = 0, r = i.length; p < r; p++) n = i[p],
                    d(k, n.nodeName) && xa(b, n) && n.getAttributeNode("name") && c.push(n);
                    k = c
                } else k = h(c, i, k, b);
                c = k
            } else {
        ...
        s;
        w = 0;
        for (lenth = k.length; w < lenth; w++) if (I = k[w], I === ">") p = !0;
        else {
            if (w > 0) {
                l = [];
                K = 0;
                for (q = r.length; K < q; K++) {
                    ...
                    j = f(I, o);
                    F = 0;
                    for (s = j.length; F < s; F++) J = j[F],
                    p ? o === J.parentNode && l.push(J) : l.push(J)
                }
                r = l
            } else r = f(I, b);
            if (r.length ===
    ...
    function Ma(a, b, c) {
        ...
        l) {
            for (var j = e.firstChild, o; j; ) {
                ...
                if (m >= 0) return !1;
                o = j.nextSibling;
                if (n > 0) if (j.nodeType == 1) if (r >= 0 && p <= 0) b && l.appendChild(j.cloneNode(!0)),
                c && f.push(j);
                else {
                    var q;
    ...
    function qb(a, b) {
        ...
        i -= n.text.replace(/\r\n|\n|\r/g, "").length;
        if (k > 0 && h.nodeType ==
        3) for (c = h.previousSibling; c && c.nodeType == 3; ) i -= c.nodeValue.length,
        c = c.previousSibling;
        return {
            node: h,
            offset: i
    ...
    function Sa(a) {
        ...
        d = a.clickEl || b,
        e = a.beforeDrag,
        g = [document]; (a.iframeFix === o || a.iframeFix) && f("iframe").each(function() {
    ...
    function Jb(a, b) {
        ...
        0) {
            ...
            Ya(e.langPath + e.langType + ".js?ver=" + encodeURIComponent(f.DEBUG ? Ca : Da),
            function() {
                c(e)
            });
            return e
    ...
    function Kb(a, b) {
        f(a).each(function(a, d) {
            f.each(_instances,
            function(a, c) {
                if (c && c.srcElement[0] == d) return b.call(c, a, c),
                !1
            })
        })
    }
    if (!A.KindEditor) {
        ...
        f.ready = function(a) {
            ...
            var e = !1;
            if (document.addEventListener) $(document, "DOMContentLoaded", b);
        ...
        E(D, {
            ...
            attr: function(a, b) {
                ...
                c;
                if (b === o) return b = c.length < 1 ? null : ya(c[0], a),
                b === null ? "" : b;
                c.each(function() {
                    Ja(this, a, b)
                });
            ...
            scan: function(a, b) {
                ...
                if (!(this.length < 1)) return b = b === o ? !0 : b,
                c(this[0]),
                this
            }
        });
        ...
        E(L, {
            ...
            compareBoundaryPoints: function(a, b) {
                ...
                if (l) {
                    ...
                    i,
                    k;
                    if (a === ka || a === la) g = this.startContainer,
                    i = this.startOffset;
                    if (a === ja || a === ca) g = this.endContainer,
                    i = this.endOffset;
                    if (a === ka || a === ja) h = b.startContainer,
                    k = b.startOffset;
                    if (a === ca || a === la) h = b.endContainer,
                    k = b.endOffset;
                    if (g === h) return g = i - k,
                    g > 0 ? 1 : g < 0 ? -1 : 0;
            ...
            createBookmark: function(a) {
                ...
                b.id = "__kindeditor_bookmark_end_" + Ob++ + "__";
        ...
        E(na, {
            ...
            select: function(a) {
                ...
                if (l) try {
                    i = c.get(!0),
                    i.select()
                } catch (r) { } else k && c.collapse(!1),
                i = c.get(!0),
                b.removeAllRanges(),
                b.addRange(i),
                g !== document && (c = f(i.endContainer).pos(), h.scrollTo(c.x, c.y));
                h.focus();
                return this
            },
            wrap: function(a) {
                ...
                f(a).scan(function(a) {
                    if (!g && a == e.start) g = !0;
                        ...
                        if (!d && b.type == 3 && B(a.nodeValue).length > 0) {
                            ...
                            n = c;
                            n = n.clone(!0);
                            if (b.type == 3) Ra(n).append(b.clone(!1)),
                            b.replaceWith(n);
                            else {
                                ...
                                d = Ra(j);
                                for (var p = j, l = !1; n; ) {
                                    for (; p; ) p.name === n.name && (Wb(p, n.attr(), n.css()), l = !0),
                                    p = p.first();
            ...
            split: function(a, b) {
                ...
                e = d.parentNode,
                e == c.endContainer && (i = f(d).prev(), g = f(d).next(), i && g && i.type == 3 && g.type == 3 ? c.setEnd(i[0], i[0].nodeValue.length) : a || c.setEnd(c.endContainer, c.endOffset -
                1)),
                e.removeChild(d);
                return this
            },
            remove: function(a) {
                ...
                if (c.collapsed) {
                    ...
                    b = c.startContainer;
                    d = c.startOffset;
                    if (d > 0 && (e = f(b.childNodes[d - 1])) && da(e)) e.remove(),
                    c.setStart(b, d - 1); (d = f(b.childNodes[d])) && da(d) && d.remove();
                ...
                if (d > 0) {
                    ...
                    n - 1));
                    if ((d = f(b.childNodes[d])) && da(d)) d.remove(),
                    b == e && c.setEnd(e, n - 1)
        ...
        function(a, b) {
            na.prototype[b] = function(a) {
                this.select();
                P(this.doc, b, a); (!l || N(b, "formatblock,selectall,insertorderedlist,insertunorderedlist".split(",")) >=
                0) && this.selection();
                return this
            }
        });
        ...
        E(R, {
            ...
            autoPos: function(a, b) {
                ...
                if (this._alignEl) {
                    ...
                    h = g.pos(),
                    c = Q(g[0].clientWidth / 2 - c / 2),
                    d = Q(g[0].clientHeight / 2 - d / 2);
                    x = c < 0 ? h.x : h.x + c;
                    y = d < 0 ? h.y : h.y + d
                } else h = G(this.doc),
                x = Q(e.x + (h.clientWidth - c) / 2),
                y = Q(e.y + (h.clientHeight - d) / 2);
                l && z < 7 || O || (x -= e.x, y -= e.y);
                return this.pos(x, y)
            },
            remove: function() {
                var a =
                this; (l && z < 7 || O) && f(a.win).unbind("scroll");
                a.div.remove();
                m(a,
                function(b) {
                    a[b] = null
        ...
        E(pa, R, {
            ...
            html: function(a, b) {
                ...
                if (this.designMode) {
                    c = c.body;
                    if (a === o) return a = b ? "<!doctype html><html>" + c.parentNode.innerHTML + "</html>" : c.innerHTML,
        ...
        E(Aa, R, {
            ...
            disableAll: function(a, b) {
                ...
                b && (d = u(b)); (a === o ? !c.disableMode : a) ? (f("span.ke-outline", c.div).each(function() {
                    var a = f(this),
        ...
        E(sa, R, {
            init: function(a) {
                ...
                n.append(a);
                a.append(d);
                var o = f('<div class="ke-dialog-footer"></div>'); (e || g || h) && n.append(o);
                m([{
                    btn: e,
                    name: "preview"
                },
        ...
        M = {};
            ta.prototype = {
                ...
                loadPlugin: function(a, b) {
                    ...
                    c.isLoading = !0;
                    Ya(c.pluginsPath + a + "/" + a + ".js?ver=" + encodeURIComponent(f.DEBUG ? Ca : Da),
                function() {
                    c.isLoading =
                    !1;
                ...
                b._scrollPos && A.scrollTo(b._scrollPos.x, b._scrollPos.y);
                    var j = [];
                    f.each(b.items,
                function(a, c) {
                ...
                p = b.edit = yb({
                    ...
                    if (b._fullscreenResizeHandler) f(A).unbind("resize", b._fullscreenResizeHandler),
                ...
                "hidden"), k.last().css("visibility", "hidden")) : (ea && f(A).bind("scroll",
                function() {
                    b._scrollPos = ba()
                }), b.resizeType > 0 ? Sa({
                    moveEl: g,
                ...
                exec: function(a) {
                    var a = a.toLowerCase(),
                b = this.cmd,
                c = N(a, "selectall,copy,paste,print".split(",")) < 0;
                ...
                (b = this.cmd.range, a = b.createBookmark(!0), a.html = $a(c.innerHTML), b.moveToBookmark(a)) : a = {
                    html: d
                };
        ...
        function(a) {
            ...
            b.afterCreate(function() {
                ...
                i,
                j,
                n = "__kindeditor_paste__",
                m = !1;
                a(d.body).bind("paste",
                function(o) {
                    if (b.pasteType === 0) o.stop();
                    else if (!m) {
                        m = !0;
                        a("div." + n, d).remove();
                        f = b.cmd.selection();
                        ...
                        if (l) {
                            ...
                            q.execCommand("paste");
                            o.preventDefault()
                        } else f.range.selectNodeContents(j[0]),
                        f.select();
                        setTimeout(function() {
                            c();
                            m =
            ...
            b.beforeGetHtml(function(a) {
                l && z <= 8 && (a = a.replace(/<div\s+[^>]*data-ke-input-tag="([^"]*)"[^>]*>([\s\S]*?)<\/div>/ig,
                function(a, b) {
                    return unescape(b)
            ...
            b.beforeSetHtml(function(a) {
                l && z <= 8 && (a = a.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/ig,
                function(a) {
                    var b = H(a);
