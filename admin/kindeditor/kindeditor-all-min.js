...
(function(b, d) {
    ...
    function z(a, c) {
        ...
        h(b,
        function(a, c) {
            if (u = /^(\d+)\.\.(\d+)$/.exec(c)) for (var b = parseInt(u[1], 10); b <= parseInt(u[2], 10); b++) f[b.toString()] = !0;
            else f[c] = !0
        });
        return f
    }
    ...
    function G(a) {
        for (var c = {},
        f = /\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g, b; b = f.exec(a); ) {
    ...
    function S(a, c) {
        return a =
        /\s+class\s*=/.test(a) ? a.replace(/(\s+class=["']?)([^"']*)(["']?[\s>])/,
        function(a, b, d, k) {
    ...
    function M(a, c, f, b) {
        ...
        if (b === d) var B = location.pathname.match(/^(\/.*)\//),
        b = B ? B[1] : "";
        var i;
        if (i = /^(\w+:\/\/[^\/]*)/.exec(a)) {
            if (i[1] !== f) return a
    ...
    function J(a, c, f, b, d) {
        ...
        g, j, n, o, s, l) {
            ...
            if (hb[m] && !Ja[m]) if (b) {
                ...
                l = g = "\n";
                o = 0;
                for (s = j ? i.length : i.length - 1; o < s; o++) g += d,
                j || (l += d);
                n ? i.pop() : j || (l += d)
            } else g = l = "";
            if (q !== "") {
                ...
                function(a, b) {
                    Jb[a] && (t[a] = a);
                    e(a, ["src", "href"]) >= 0 && (t[a] = M(b, f)); (c && a !== "style" && !B[m]["*"] && !B[m][a] || m === "body" && a === "contenteditable" || /^kindeditor_\d+$/.test(a)) && delete t[a];
                    if (a === "style" && b !== "") {
                        var d = Q(b);
                        h(d,
                        function(a) {
    ...
    function W(a, c) {
        ...
        "").replace(/<style[^>]*>[\s\S]*?<\/style>/ig, "").replace(/<script[^>]*>[\s\S]*?<\/script>/ig, "").replace(/<w:[^>]+>[\s\S]*?<\/w:[^>]+>/ig, "").replace(/<o:[^>]+>[\s\S]*?<\/o:[^>]+>/ig, "").replace(/<xml>[\s\S]*?<\/xml>/ig, "").replace(/<(?:table|td)[^>]*>/ig,
        function(a) {
    ...
    function Da(a, c) {
        ...
        function d(a, c, f) {
            var u = []; (a = (f.ownerDocument || f).getElementById(a.replace(/\\/g, ""))) && b(c, a.nodeName) && Ba(f, a) && u.push(a);
            return u
        }
        function k(a, c, f) {
            var d = f.ownerDocument || f,
            u = [],
            k,
            i,
            B;
            if (f.getElementsByClassName) {
                ...
                k = 0;
                for (i = d.length; k < i; k++) B = d[k],
                b(c, B.nodeName) && u.push(B)
        ...
        function i(a, c, b, d) {
            for (var K = [], b = d.getElementsByTagName(b), u = 0, k = b.length; u < k; u++) d = b[u],
            d.nodeType == 1 && (c === null ? Ca(d, a) !== null && K.push(d) : c === f(Ca(d, a)) && K.push(d));
            return K
        }
        function g(a, c) {
            var f = [],
            e,
            P = (e = /^((?:\\.|[^.#\s\[<>])+)/.exec(a)) ? e[1] : "*";
            if (e = /#((?:[\w\-]|\\.)+)$/.exec(a)) f = d(e[1], P, c);
            else if (e = /\.((?:[\w\-]|\\.)+)$/.exec(a)) f = k(e[1], P, c);
            else if (e = /\[((?:[\w\-]|\\.)+)\]/.exec(a)) f =
            i(e[1].toLowerCase(), null, P, c);
            else if (e = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(a)) {
                f = e[1].toLowerCase();
                e = e[2];
                if (f === "id") P = d(e, P, c);
                else if (f === "class") P = k(e, P, c);
                else if (f === "name") {
                    f = [];
                    e = (c.ownerDocument || c).getElementsByName(e.replace(/\\/g, ""));
                    for (var h, j = 0, o = e.length; j < o; j++) h = e[j],
                    b(P, h.nodeName) && Ba(c, h) && h.getAttributeNode("name") && f.push(h);
                    P = f
                } else P = i(f, e, P, c);
                f = P
            } else {
        ...
        v;
        p = 0;
        for (lenth = j.length; p < lenth; p++) if (l = j[p], l === ">") m = !0;
        else {
            if (p > 0) {
                s = [];
                r = 0;
                for (F = o.length; r < F; r++) {
                    ...
                    q = g(l, t);
                    N = 0;
                    for (v = q.length; N < v; N++) w = q[N],
                    m ? t === w.parentNode && s.push(w) : s.push(w)
                }
                o = s
            } else o = g(l, c);
            if (o.length ===
    ...
    function Oa(a, c, f) {
        ...
        u) {
            for (var m = d.firstChild, l; m; ) {
                ...
                if (n >= 0) return !1;
                l = m.nextSibling;
                if (h > 0) if (m.nodeType == 1) if (j >= 0 && o <= 0) c && u.appendChild(m.cloneNode(!0)),
                f && e.push(m);
                else {
                    var s;
    ...
    function kb(a, c) {
        var f = a.parentElement().ownerDocument,
        b = a.duplicate();
        b.collapse(c);
        ...
        for (var j = 0, o = k.length; j < o; j++) {
            var n = k[j],
            g = h.compareEndPoints("StartToStart", b);
            if (g === 0) return {
                node: n.parentNode,
                offset: j
            };
        ...
        e -= h.text.replace(/\r\n|\n|\r/g, "").length;
        if (g > 0 && B.nodeType ==
        3) for (f = B.previousSibling; f && f.nodeType == 3; ) e -= f.nodeValue.length,
        f = f.previousSibling;
        return {
            node: B,
            offset: e
    ...
    function lb(a, c) {
        ...
        b = f.body.createTextRange();
        if (f == a) return b.collapse(!0),
        b;
    ...
    function mb(a) {
        ...
        var f;
        if (C) {
            if (a.item) return f = ga(a.item(0)),
            f = new Z(f),
            f.selectNode(a.item(0)),
            f;
    ...
    function $a(a, c) {
        var f = document.getElementsByTagName("head")[0] || (aa ? document.body : document.documentElement),
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    ...
                    function() {
                        ...
                        else if (this.cond && this.cond() && (b.push(this), this.width && this.width > f)) f = this.width
    ...
    function Rb() {
        ...
        i(c).keydown(function(f) {
            if (f.which == 9) if (f.preventDefault(), a.afterTab) a.afterTab.call(a, f);
            else {
                var f = a.cmd,
                b = f.range;
                b.shrink();
    ...
    function Cb(a, c) {
        ...
        f.designMode ? (d = this.cmd.range, k = d.createBookmark(!0), k.html = b.innerHTML) : k = {
            html: b.innerHTML
        };
        Bb(c, k);
        var e = a.pop();
    ...
    function Db(a, c) {
        ...
        0) {
            ...
            $a(d.langPath + d.langType + ".js?ver=" + encodeURIComponent(i.DEBUG ? Ga : Ha),
            function() {
                f(d)
            });
            return d
    ...
    function Eb(a, c) {
        i(a).each(function(a, b) {
            i.each(_instances,
            function(a, f) {
                if (f && f.srcElement[0] == b) return c.call(f, a, f),
                !1
            })
        })
    }
    if (!b.KindEditor) {
        ...
        var Ha = "4.1.7 (2013-04-21)",
        I = navigator.userAgent.toLowerCase(),
        C = I.indexOf("msie") > -1 && I.indexOf("opera") == -1,
        pa = I.indexOf("gecko") > -1 && I.indexOf("khtml") == -1,
        ja = I.indexOf("applewebkit") > -1,
        Na = I.indexOf("opera") > -1,
        Tb = I.indexOf("mobile") > -1,
        Ub = /ipad|iphone|ipod/.test(I),
        aa = document.compatMode != "CSS1Compat",
        O = (I = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(I)) ? I[1] : "0",
        Ga = (new Date).getTime(),
        ca = Math.round,
        i = {
            DEBUG: !1,
        ...
        gb = z("a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),
        hb = z("address,applet,blockquote,body,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,head,hr,html,iframe,ins,isindex,li,map,menu,meta,noframes,noscript,object,ol,p,pre,script,style,table,tbody,td,tfoot,th,thead,title,tr,ul"),
        fb = z("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"),
        ...
        var la = "kindeditor_" + Ga,
        eb = 0,
        L = {};
        C && b.attachEvent("onunload",
        function() {
            h(L,
            function(a, c) {
                c.el && N(c.el)
        ...
        i.ready = function(a) {
            ...
            var i = !1;
            if (document.addEventListener) F(document, "DOMContentLoaded", c);
        ...
        A(R, {
            ...
            attr: function(a, c) {
                ...
                f;
                if (c === d) return c = f.length < 1 ? null : Ca(f[0], a),
                c === null ? "" : c;
                f.each(function() {
                    La(this, a, c)
                });
        ...
        A(Z, {
            ...
            compareBoundaryPoints: function(a, c) {
                ...
                if (C) {
                    ...
                    h,
                    j;
                    if (a === ra || a === sa) k = this.startContainer,
                    h = this.startOffset;
                    if (a === qa || a === na) k = this.endContainer,
                    h = this.endOffset;
                    if (a === ra || a === qa) g = c.startContainer,
                    j = c.startOffset;
                    if (a === na || a === sa) g = c.endContainer,
                    j = c.endOffset;
                    if (k === g) return k = h - j,
                    k > 0 ? 1 : k < 0 ? -1 : 0;
            ...
            createBookmark: function(a) {
                ...
                c.id = "__kindeditor_bookmark_end_" + Ib++ + "__";
        ...
        A(ua, {
            ...
            select: function(a) {
                ...
                if (C) try {
                    h = b.get(!0),
                    h.select()
                } catch (o) { } else j && b.collapse(!1),
                h = b.get(!0),
                c.removeAllRanges(),
                c.addRange(h),
                k !== document && (b = i(h.endContainer).pos(), g.scrollTo(b.x, b.y));
                g.focus();
                return this
            },
            wrap: function(a) {
                ...
                i(a).scan(function(a) {
                    if (!k && a == e.start) k = !0;
                        ...
                        if (!d && c.type == 3 && m(a.nodeValue).length > 0) {
                            ...
                            g = b;
                            g = g.clone(!0);
                            if (c.type == 3) Ta(g).append(c.clone(!1)),
                            c.replaceWith(g);
                            else {
                                ...
                                d = Ta(h);
                                for (var j = h, n = !1; g; ) {
                                    for (; j; ) j.name === g.name && (Nb(j, g.attr(), g.css()), n = !0),
                                    j = j.first();
            ...
            split: function(a, c) {
                ...
                a ? e.setStartBefore(h.firstChild).setEnd(k, g) : e.setStart(k, g).setEndAfter(h.lastChild),
                k = e.extractContents(),
                g = k.firstChild,
                j = k.lastChild,
                a ? (e.insertNode(k), b.setStartAfter(j).setEndBefore(d)) : (h.appendChild(k), b.setStartBefore(d).setEndBefore(g)),
                e = d.parentNode,
                e == b.endContainer && (h = i(d).prev(), k = i(d).next(), h && k && h.type == 3 && k.type == 3 ? b.setEnd(h[0], h[0].nodeValue.length) : a || b.setEnd(b.endContainer, b.endOffset -
                1)),
                e.removeChild(d);
                return this
            },
            remove: function(a) {
                ...
                if (b.startOffset === 0) {
                    ...
                    d.isBlock() && Sa(d, a); (d = d.parent()) && d.isBlock() && Sa(d, a)
                }
                if (b.collapsed) {
                    this.split(!0, a);
                    c = b.startContainer;
                    d = b.startOffset;
                    if (d > 0 && (e = i(c.childNodes[d - 1])) && oa(e)) e.remove(),
                    b.setStart(c, d - 1); (d = i(c.childNodes[d])) && oa(d) && d.remove();
                ...
                if (d > 0) {
                    ...
                    o - 1));
                    if ((d = i(c.childNodes[d])) && oa(d)) d.remove(),
                    c == e && b.setEnd(e, o - 1)
            ...
            val: function(a) {
                ...
                a = a.toLowerCase(),
                b = "";
                if (a === "fontfamily" || a === "fontname") return b = nb(c, "fontname"),
                b = b.replace(/['"]/g, ""),
                b.toLowerCase();
                if (a === "formatblock") {
                    b = nb(c, a);
        ...
        function(a, c) {
            ua.prototype[c] = function(a) {
                this.select();
                ba(this.doc, c, a); (!C || e(c, "formatblock,selectall,insertorderedlist,insertunorderedlist".split(",")) >=
                0) && this.selection();
                return this
            }
        });
        ...
        A(da, {
            ...
            autoPos: function(a, c) {
                ...
                x = ca(e.x + (g.clientWidth - b) / 2),
                y = ca(e.y + (g.clientHeight - d) / 2);
                C && O < 7 || aa || (x -= e.x, y -= e.y);
                return this.pos(x, y)
            },
            remove: function() {
                var a = this; (C && O < 7 || aa) && i(a.win).unbind("scroll");
                a.div.remove();
                h(a,
                function(c) {
                    a[c] = null
        ...
        A(wa, da, {
            init: function(a) {
                ...
                j = C ? ' src="javascript:void(function(){' + encodeURIComponent(j) + '}())"' : "";
        ...
        A(za, da, {
            init: function(a) {
                ...
                m.append(a);
                a.append(d);
                var l = i('<div class="ke-dialog-footer"></div>'); (e || k || g) && m.append(l);
                h([{
                    btn: e,
                    name: "preview"
                },
        ...
        $ = {};
            Aa.prototype = {
                ...
                loadPlugin: function(a, c) {
                    var b = this;
                    if (ia[a]) {
                        if (b._calledPlugins[a]) return c && c.call(b),
                    b;
                    ...
                    b.isLoading = !0;
                    $a(b.pluginsPath + a + "/" + a + ".js?ver=" + encodeURIComponent(i.DEBUG ? Ga : Ha),
                function() {
                    b.isLoading =
                    !1;
                ...
                handler: function(a, c) {
                    ...
                    if (l(c)) return b._handlers[a].push(c),
                b;
                    h(b._handlers[a],
                function() {
                    c = this.call(b, c)
                ...
                s = o(g) - h.div.height(),
                q = c.edit = sb({
                    height: s > 0 && o(g) > c.minHeight ? s : c.minHeight,
                    src: n,
                ...
                "hidden"), m.last().css("visibility", "hidden")) : (pa && i(b).bind("scroll",
                function() {
                    c._scrollPos = ma()
                }), c.resizeType > 0 ? Ua({
                    moveEl: k,
                ...
                }) : m.first().css("visibility", "hidden"), c.resizeType === 2 ? Ua({
                    moveEl: k,
                    clickEl: m.last(),
                    moveFn: function(a, b, d, f, e, i) {
                        d += e;
                ...
                (b = this.cmd.range, a = b.createBookmark(!0), a.html = bb(d.innerHTML), b.moveToBookmark(a)) : a = {
                    html: e
                };
        ...
        function(a) {
            ...
            c.afterCreate(function() {
                ...
                e,
                i,
                g = "__kindeditor_paste__",
                h = !1;
                a(d.body).bind("paste",
                function(j) {
                    if (c.pasteType === 0) j.stop();
                    else if (!h) {
                        h = !0;
                        a("div." + g, d).remove();
                        f = c.cmd.selection();
                        e = f.range.createBookmark();
                        i = a('<div class="' + g + '"></div>', d).css({
                            position: "absolute",
                            width: "1px",
                            height: "1px",
                            overflow: "hidden",
            ...
            c.beforeGetHtml(function(a) {
                C && O <= 8 && (a = a.replace(/<div\s+[^>]*data-ke-input-tag="([^"]*)"[^>]*>([\s\S]*?)<\/div>/ig,
                function(a, b) {
                    return unescape(b)
            ...
            c.beforeSetHtml(function(a) {
                C && O <= 8 && (a = a.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/ig,
                function(a) {
                    var b = G(a);
...
function(b) {
    ...
    d.plugin.anchor = {
        edit: function() {
            ...
            e = b('input[name="name"]', l); (l = d.plugin.getSelectedAnchor()) && e.val(unescape(l.attr("data-ke-name")));
            e[0].focus();
            e[0].select()
        },
        "delete": function() {
...
function(b) {
    ...
    function() {
        ...
        g.search + '" />', '</span></div><div class="ke-right">', '<input type="checkbox" id="keInsertDynamicMap" name="insertDynamicMap" value="1" /> <label for="keInsertDynamicMap">' + g.insertDynamicMap + "</label>", '</div><div class="ke-clearfix"></div></div>', '<div class="ke-map" style="width:' + l + "px;height:" + e + 'px;"></div>', "</div>"].join(""),
        m = d.createDialog({
            name: "baidumap",
            width: l + 42,
            ...
            yesBtn: {
                ...
                click: function() {
                    ...
                    g = g.lng + "," + g.lat,
                    b = b.getZoom(),
                    b = [s[0].checked ? d.pluginsPath + "baidumap/index.html" : "http://api.map.baidu.com/staticimage", "?center=" + encodeURIComponent(g), "&zoom=" + encodeURIComponent(b), "&width=" + l, "&height=" + e, "&markers=" + encodeURIComponent(g), "&markerStyles=" + encodeURIComponent("l,A")].join("");
        ...
        t,
        p,
        q = b('<iframe class="ke-textarea" frameborder="0" src="' + d.pluginsPath + 'baidumap/map.html" style="width:' + l + "px;height:" + e + 'px;"></iframe>');
        q.bind("load",
        function() {
            q.unbind("load");
    ...
    function() {
        ...
        l = d.createDialog({
            ...
            yesBtn: {
                name: d.lang("yes"),
                click: function() {
                    var h = b(".ke-code-type", l.div).val(),
                    m = e.val(),
...
function(b) {
    var d = this,
    g = d.emoticonsPath || d.pluginsPath + "emoticons/images/",
...
function(b) {
    ...
    e = g.pluginsPath + "filemanager/images/",
    h = g.lang("filemanager.");
    g.plugin.filemanagerDialog = function(m) {
        function n(d, e, h) {
            d = "path=" + d + "&order=" + e + "&dir=" + z;
            A.showLoading(g.lang("ajaxLoading"));
            b.ajax(b.addParam(l, d + "&" + (new Date).getTime()),
            function(b) {
                A.hideLoading();
                h(b)
            })
        ...
        function s(d) {
            ...
            for (var n = d.file_list, m = 0, l = n.length; m < l; m++) {
                ...
                var p = b('<img src="' + (e + (q.is_dir ? "folder-16.gif" : "file-16.gif")) + '" width="16" height="16" alt="' + q.filename + '" align="absmiddle" />'),
                p =
                b(t[0].insertCell(0)).addClass("ke-cell ke-name").append(p).append(document.createTextNode(" " + q.filename)); !q.is_dir || q.has_file ? (t.css("cursor", "pointer"), p.attr("title", q.filename), j(p, d, q, s)) : p.attr("title", h.emptyFolder);
        ...
        function t(g) {
            ...
            for (var n = g.file_list, m = 0, l = n.length; m < l; m++) {
                ...
                r = b('<img src="' + (s.is_dir ? e + "folder-64.gif" : s.is_photo ? r : e + "file-64.gif") + '" width="80" height="80" alt="' + s.filename + '" />'); !s.is_dir || s.has_file ? (p.css("cursor", "pointer"), d(p, s), j(p, g, s, t)) : p.attr("title", h.emptyFolder);
                p.append(r);
        ...
        b('[name="viewServer"]', p);
        var v = b('[name="viewType"]', p),
        E = b('[name="orderType"]', p),
        U = [];
        v.val(D);
        n("", E.val(), D == "VIEW" ? t : s);
        return A
...
function(b) {
    var d = this,
    g = d.lang("flash."),
    l = b.undef(d.allowFlashUpload, !0),
    ...
    d.plugin.flash = {
        edit: function() {
            ...
            g.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" /> </div></div>'].join(""),
            s = d.createDialog({
                name: "flash",
                width: 450,
                title: d.lang("flash"),
                ...
                yesBtn: {
                    ...
                    click: function() {
                        ...
                        g = q.val(),
                        h = z.val();
                        e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")), p[0].focus()) : /^\d*$/.test(g) ? /^\d*$/.test(h) ? (e = b.mediaImg(d.themesPath + "common/blank.gif", {
                            src: e,
                            type: b.mediaType(".swf"),
                            width: g,
                            height: h,
                            quality: "high"
                        }), d.insertHtml(e).hideDialog().focus()) : (alert(d.lang("invalidHeight")), z[0].focus()) : (alert(d.lang("invalidWidth")), q[0].focus())
                    }
                }
            }),
            t = s.div,
            p = b('[name="url"]', t),
            o = b('[name="viewServer"]', t),
            q = b('[name="width"]', t),
            z = b('[name="height"]', t);
            p.val("http://");
            if (l) {
...
function(b) {
    var d = this,
    g = b.undef(d.allowImageUpload, !0),
    l = b.undef(d.allowImageRemote, !0),
    ...
    j = d.pluginsPath + "image/images/",
    o = b.undef(d.extraFileUploadParams, {}),
    s = b.undef(d.filePostName, "imgFile"),
    t = b.undef(d.fillDescAfterUploadImage, !1),
    p = d.lang("image.");
    d.plugin.imageDialog = function(g) {
        ...
        var l = b.undef(g.showRemote, !0),
        r = b.undef(g.showLocal, !0),
        A = b.undef(g.tabIndex, 0),
        w = g.clickFn,
        H = "kindeditor_upload_iframe_" + (new Date).getTime(),
        v = [],
        E;
        ...
        U = d.createDialog({
            ...
            yesBtn: {
                name: d.lang("yes"),
                click: function() {
                    if (!U.isLoading) if (r && l && J && J.selectedIndex === 1 || !l) W.fileBox.val() == "" ? alert(d.lang("pleaseSelectFile")) : (U.showLoading(d.lang("uploadLoading")), W.submit(), ea.val(""));
                    else {
                        var e = b.trim(N.val()),
                        g = Q.val(),
                        h = G.val(),
        ...
        F = U.div,
        N = b('[name="url"]', F),
        ea = b('[name="localUrl"]', F),
        V = b('[name="viewServer"]', F),
        Q = b('.tab1 [name="width"]', F),
        G = b('.tab1 [name="height"]', F),
        S = b(".ke-refresh-btn", F),
        Y = b('.tab1 [name="title"]', F),
        M = b('.tab1 [name="align"]', F),
        J;
        l && r ? (J = b.tabs({
            src: b(".tabs", F),
            ...
            title: p.localImage,
            panel: b(".tab2", F)
        }), J.select(A)) : l ? b(".tab1", F).show() : r && b(".tab2", F).show();
        ...
        Y.val(g.imageTitle);
        M.each(function() {
            if (this.value === g.imageAlign) return this.checked = !0,
            !1
        });
...
function(b) {
    ...
    var d = this,
    g = b.undef(d.allowFileUpload, !0),
    l = b.undef(d.allowFileManager, !1),
    e = b.undef(d.formatUploadUrl, !0),
    ...
    d.plugin.fileDialog = function(o) {
        var s = b.undef(o.fileUrl, "http://"),
        t = b.undef(o.fileTitle, ""),
        p = o.clickFn,
        o = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + j.url +
...
function(b) {
    var d = this,
    g = d.lang("media."),
    l = b.undef(d.allowMediaUpload, !0),
    e = b.undef(d.allowFileManager, !1),
    h = b.undef(d.formatUploadUrl, !0),
    m = b.undef(d.extraFileUploadParams, {}),
    n = b.undef(d.filePostName, "imgFile"),
    ...
    d.plugin.media = {
        edit: function() {
            var o = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + g.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;',
            '<input type="button" class="ke-upload-button" value="' + g.upload + '" /> &nbsp;', '<span class="ke-button-common ke-button-outer">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + g.viewServer + '" />', '</span></div><div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + g.width + "</label>", '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="550" maxlength="4" /></div><div class="ke-dialog-row">', '<label for="keHeight" style="width:60px;">' +
            g.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" /></div><div class="ke-dialog-row">', '<label for="keAutostart">' + g.autostart + "</label>", '<input type="checkbox" id="keAutostart" name="autostart" value="" /> </div></div>'].join(""),
            s = d.createDialog({
                name: "media",
                width: 450,
                height: 230,
                ...
                yesBtn: {
                    ...
                    click: function() {
                        ...
                        (alert(d.lang("invalidUrl")), p[0].focus()) : /^\d*$/.test(g) ? /^\d*$/.test(h) ? (e = b.mediaImg(d.themesPath + "common/blank.gif", {
                            src: e,
                            type: b.mediaType(e),
                            width: g,
                            height: h,
...
function(b) {
    ...
    d.plugin.multiImageDialog = function(j) {
        ...
        t = b.swfupload({
            ...
            buttonImageUrl: l + (d.langType == "zh_CN" ? "select-files-zh_CN.png" : "select-files-en.png"),
    ...
    SWFUpload.prototype.callFlash = function(b, d) {
        ...
        e;
        try {
            e = g.CallFunction('<invoke name="' + b + '" returntype="javascript">' + __flash__argumentsToXML(d, 0) + "</invoke>"),
            l = eval(e)
        } catch (h) {
    ...
    SWFUpload.prototype.setButtonDimensions = function(b, d) {
        ...
        if (g != void 0) g.style.width = b + "px",
        g.style.height = d + "px";
...
function(b) {
    var d = this,
    g = b.undef(d.pagebreakHtml, '<hr style="page-break-after: always;" class="ke-pagebreak" />');
...
function(b) {
    ...
    function() {
        var g = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + d.lang("plainpaste.").comment + '</div><textarea class="ke-textarea" style="width:408px;height:260px;"></textarea></div>',
        g = d.createDialog({
            name: "plainpaste",
            width: 450,
...
function(b) {
    ...
    e.plugin.table = {
            ...
            j = e.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function() {
                        ...
                        o[0].focus();
                        else if (g == 0 || !/^\d+$/.test(g)) alert(e.lang("invalidRows")),
                        l[0].focus();
                        else if (/^\d*$/.test(h)) if (/^\d*$/.test(j)) if (/^\d*$/.test(G)) if (/^\d*$/.test(S)) if (/^\d*$/.test(M)) if (v) h !== "" ? v.width(h + n) : v.css("width", ""),
                        v[0].width !== void 0 && v.removeAttr("width"),
                        j !== "" ? v.height(j + E) : v.css("height", ""),
                        v[0].height !== void 0 && v.removeAttr("height"),
                        v.css("background-color", W),
                        v[0].bgColor !==
                        void 0 && v.removeAttr("bgColor"),
                        G !== "" ? v[0].cellPadding = G : v.removeAttr("cellPadding"),
                        S !== "" ? v[0].cellSpacing = S : v.removeAttr("cellSpacing"),
                        Y !== "" ? v[0].align = Y : v.removeAttr("align"),
                        M !== "" ? v.attr("border", M) : v.removeAttr("border"),
                        M === "" || M === "0" ? v.addClass("ke-zeroborder") : v.removeClass("ke-zeroborder"),
                        J !== "" ? v.attr("borderColor", J) : v.removeAttr("borderColor"),
                        e.hideDialog().focus();
                        else {
                            var T = "";
                            h !== "" && (T += "width:" + h + n + ";");
        ...
        cellprop: function() {
            ...
            n = e.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function() {
                        ...
                        Q = b(A[0]).html() || "",
                        G = b(A[1]).html() || "";
                        /^\d*$/.test(d) ? /^\d*$/.test(g) ? /^\d*$/.test(V) ? (w.css({
                            width: d !== "" ? d + h : "",
                            height: g !== "" ? g + n : "",
                            "background-color": G,
                            "text-align": H,
            ...
            H = w[0].style.height || w[0].height || ""; (n = /^(\d+)((?:px|%)*)$/.exec(w[0].style.width || w[0].width || "")) ? (j.val(n[1]), l.val(n[2])) : j.val("");
            if (n = /^(\d+)((?:px|%)*)$/.exec(H)) o.val(n[1]),
            m.val(n[2]);
            z.val(w[0].style.textAlign || "");
            D.val(w[0].style.verticalAlign || ""); (n = w[0].style.borderWidth || "") && (n = parseInt(n));
            r.val(n);
        ...
        rowmerge: function() {
            ...
            h = d.rowIndex + g.rowSpan,
            d = b.rows[h];
            if (!(b.rows.length <= h)) b = g.cellIndex,
            d.cells.length <= b || (h = d.cells[b],
...
function(b) {
    ...
    function() {
        var g = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + d.lang("wordpaste.").comment + '</div><iframe class="ke-textarea" frameborder="0" style="width:408px;height:260px;"></iframe></div>',
        g = d.createDialog({
            name: "wordpaste",
            width: 450,
