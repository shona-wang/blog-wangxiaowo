 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cp_product_Index.aspx.cs" Inherits="product_Cp_product_Cp_product_index" %>
 ...
 <script type="text/javascript">
    ...
    Cp_productgrid.on("drawcell", function(e) {
     ...
     //debugger;
          ...
          title: "新增-产品信息", width: 750, height: 550,
          onload: function() {
      ...
      if (row) {
          mini.open({
              ...
              title: "修改-产品信息", width: 750, height: 550,
              onload: function() {
                  var iframe = this.getIFrameEl();
