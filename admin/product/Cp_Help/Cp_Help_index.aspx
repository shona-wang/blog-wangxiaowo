 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cp_Help_Index.aspx.cs" Inherits="product_Cp_Help_Cp_Help_index" %>
 ...
 <script type="text/javascript">
    ...
    Cp_Helpgrid.on("drawcell", function(e) {
     ...
     function add() {
          ...
          title: "新增-帮助信息", width: 750, height: 600,
          onload: function() {
      ...
      if (row) {
          mini.open({
              ...
              title: "修改-帮助信息", width: 750, height:600,
              onload: function() {
                  var iframe = this.getIFrameEl();
