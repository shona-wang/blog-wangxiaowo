<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_Type.aspx.cs" Inherits="product_ZiDian_Product_Type" %>
...
<body>
  ...
  <div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%x; height:100%" url="../../WindowsAspx/AspxDate.aspx?method=Select_Where&&YWLX=CPLB"
...
<script type="text/javascript">
    ...
    function addRow() {
        mini.open({
            ...
            title: "新增-产品类别", width: 350, height: 200,
            onload: function() {
                var iframe = this.getIFrameEl();
                var data = { action: "Add", YWLX: 'CPLB' };
    ...
    function edit() {
        ...
        if (row) {
            mini.open({
                ...
                url: "../ZiDian/ZiDian_Edit.aspx",
                title: "修改-产品类别", width: 350, height: 200,
                onload: function() {
                    var iframe = this.getIFrameEl();
