<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help_Type.aspx.cs" Inherits="product_ZiDian_Help_Type" %>
...
<body>
  ...
  <div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%x; height:100%" url="../../WindowsAspx/AspxDate.aspx?method=Select_Where&&YWLX=BZLB"
...
<script type="text/javascript">
    ...
    function addRow() {
        mini.open({
            ...
            title: "新增-技术帮助类别", width: 350, height: 200,
            onload: function() {
                var iframe = this.getIFrameEl();
                var data = { action: "Add", YWLX: 'BZLB' };
    ...
    function edit() {
        ...
        if (row) {
            mini.open({
                ...
                url: "../ZiDian/ZiDian_Edit.aspx",
                title: "修改-技术帮助类别", width: 350, height: 200,
                onload: function() {
                    var iframe = this.getIFrameEl();
