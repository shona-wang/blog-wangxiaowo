<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KH_LaiYuan.aspx.cs" Inherits="CustomersAspx_KHZD_KH_LaiYuan" %>
...
<body>
  ...
  <div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%x; height:100%" url="../../WindowsAspx/AspxDate.aspx?method=Select_Where&&YWLX=KHLY"
...
<script type="text/javascript">
    ...
    function addRow() {
        mini.open({
            ...
            title: "新增-客户来源", width: 350, height: 200,
            onload: function() {
                var iframe = this.getIFrameEl();
                var data = { action: "Add", YWLX: 'KHLY' };
    ...
    function edit() {
        ...
        if (row) {
            mini.open({
                ...
                url: "../ZiDian/ZiDian_Edit.aspx",
                title: "修改-客户来源", width: 350, height: 200,
                onload: function() {
                    var iframe = this.getIFrameEl();
