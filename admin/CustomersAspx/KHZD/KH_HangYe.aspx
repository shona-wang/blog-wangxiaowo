<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KH_HangYe.aspx.cs" Inherits="CustomersAspx_KHZD_KH_HangYe" %>
...
<body>
  ...
  <div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%x; height:100%" url="../../WindowsAspx/AspxDate.aspx?method=Select_Where&&YWLX=KHHY"
...
<script type="text/javascript">
    ...
    function addRow() {
        mini.open({
            ...
            title: "新增-客户行业", width: 350, height: 200,
            onload: function() {
                var iframe = this.getIFrameEl();
                var data = { action: "Add", YWLX: 'KHHY' };
    ...
    function edit() {
        ...
        if (row) {
            mini.open({
                ...
                url: "../ZiDian/ZiDian_Edit.aspx",
                title: "修改-客户行业", width: 350, height: 200,
                onload: function() {
                    var iframe = this.getIFrameEl();
