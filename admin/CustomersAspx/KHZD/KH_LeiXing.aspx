<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KH_LeiXing.aspx.cs" Inherits="CustomersAspx_KHZD_KH_LeiXing" %>
...
<body>
  ...
  <div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%x; height:100%" url="../../WindowsAspx/AspxDate.aspx?method=Select_Where&&YWLX=KHLX"
...
<script type="text/javascript">
    ...
    function addRow() {
        mini.open({
            ...
            title: "新增-客户类型", width: 350, height: 200,
            onload: function() {
                var iframe = this.getIFrameEl();
                var data = { action: "Add", YWLX: 'KHLX' };
    ...
    function edit() {
        ...
        if (row) {
            mini.open({
                ...
                url: "../ZiDian/ZiDian_Edit.aspx",
                title: "修改-客户类型", width: 350, height: 200,
                onload: function() {
                    var iframe = this.getIFrameEl();
