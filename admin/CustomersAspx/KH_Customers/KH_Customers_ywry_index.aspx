<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KH_Customers_ywry_index.aspx.cs" Inherits="CustomersAspx_KH_Customers_KH_Customers_ywry_index" %>
    ...
    function edit() {
        ...
        if (row) {
            mini.open({
                ...
                onload: function() {
                    var iframe = this.getIFrameEl();
                    var data = { action: "Edit", DJBH: row.Cust_ID,zt:'ywgl' }; //此处需要手动调整，代码生成器不做太多判断了
    ...
    function SeelctCx() {
        ...
        mini.open({
            ...
            ondestroy: function() {
                ...
                KH_Customersgrid.load({zt:'ywgl',Where: Where });
            }
        });
    }
    //高级查询调用函数
