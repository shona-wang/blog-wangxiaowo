<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MinZhu_Index.aspx.cs" Inherits="ZiDian_MinZhu_Index" %>
...
<body>
  ...
  <div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%x; height:100%" url="../WindowsAspx/AspxDate.aspx?method=Select_Where&&YWLX=MZZD"
        idfield="DJBH" allowresize="true" pagesize="100" multiselect="true" allowSortColumn="false">
        <div property="columns">
            ...
            <div field="PYM" width="120" headeralign="center" allowsort="true">
              拼音码
            </div>
...
<script type="text/javascript">
    ...
    function addRow() {
        ...
        title: "新增-民族字典", width: 350, height:250,
            onload: function() {
                var iframe = this.getIFrameEl();
                var data = { action: "Add", YWLX: 'MZZD' };
    ...
    function edit() {
        ...
        if (row) {
            ...
            url: "../ZiDian/ZiDian_Edit.aspx",
            title: "修改-民族字典", width: 350, height: 250,
                onload: function() {
                    var iframe = this.getIFrameEl();
    ...
    function SaveDataOrder() {
        ...
        data: { data: GridJson },
        type: "post",
        url: "../WindowsAspx/AspxDate.aspx?method=UpZiDian_XuHao",
            success: function(text) {
                if (text != -1) {
                    grid.reload();
                }
