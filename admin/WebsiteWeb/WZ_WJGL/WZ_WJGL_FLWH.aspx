<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WZ_WJGL_FLWH.aspx.cs" Inherits="WZ_WJGL_WZ_WJGL_FLWH" %>
     ...
     <!--按钮菜单功能-->
            ...
            <table style="width:100%;">
                <tr>
                    <td style="white-space:nowrap;">
                        <label for="textbox1$text">类别名称</label>
                        <input id="key" class="mini-textbox" emptyText="请输入类别名称" style="width:150px;" onenter="onKeyEnter"/>
        ...
        <div class="mini-fit" >
            <div id="dept_grid" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true" 
                url="../WZ_DealData/DataProcess.aspx?method=WJLBLoad"  idfield="FileTypeID" allowcelledit="false" allowcellselect="true" multiSelect="false" emptyText="数据为空，<a href='javascript:newRow()'>增加一条</a>" showEmptyText="true">
                <div property="columns">
                   <div type="checkcolumn"></div>
                   <div type="indexcolumn"  style="width:6px;" headerAlign="center">序号</div>      
                   <div field="FileTypeID" width="100" headerAlign="center" visible="false" >编号</div>   
                   <div field="AccountNum" width="100" headerAlign="center" visible="false">帐套号</div>  
                   <div field="FileTypeName" width="100" headerAlign="center" >类别名称<input property="editor" class="mini-textbox" name="editor1" id="editor1" style="width:100%;" /></div>
...
<script type="text/javascript">
    ...
    function delRow(row_uid) {
        ...
        if (row) {
            if (confirm("确定删除此记录？")) {
                ...
                $.ajax({
                url: "../WZ_DealData/DataProcess.aspx?method=DeleteWJLB&LBBH=" + row.FileTypeID,
    ...
    function updateRow(row_uid) {
        ...
        $.ajax({
            url: "../WZ_DealData/DataProcess.aspx?method=SaveWJLB",
            data: { data: json },
            success: function(text) {
                if (text == "") {
                    alert("保存成功!");
