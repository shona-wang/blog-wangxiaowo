<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WZ_JCXX_XFLXWH.aspx.cs" Inherits="WZ_JCXX_WZ_JCXX_XFLXWH" %>
     ...
     <!--按钮菜单功能-->
            ...
            <table style="width:100%;">
                <tr>
                    <td style="white-space:nowrap;">
                        <label for="textbox1$text">类型名称</label>
                        <input id="key" class="mini-textbox" emptyText="请输入类型名称" style="width:150px;" onenter="onKeyEnter"/>
        ...
        <div class="mini-fit" >
            <div id="dept_grid" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true" 
                url="../WZ_DealData/DataProcess.aspx?method=XFLXLoad"  idfield="ID" allowcelledit="false" allowcellselect="true" multiSelect="false" emptyText="数据为空，<a href='javascript:newRow()'>增加一条</a>" showEmptyText="true">
                <div property="columns">
                   ...
                   <div field="LXMC" width="100" headerAlign="center" >信访类型名称<input property="editor" class="mini-textbox" name="editor1" id="editor1" style="width:100%;" /></div>
                   <div field="BS" width="100" headerAlign="center" visible="false">是否删除</div>
...
<script type="text/javascript">
    ...
    function delRow(row_uid) {
        ...
        if (row) {
            if (confirm("确定删除此记录？")) {
                ...
                $.ajax({
                    url: "../WZ_DealData/DataProcess.aspx?method=DeleteXFLX&ID=" + row.ID,
    ...
    function updateRow(row_uid) {
        ...
        $.ajax({
            url: "../WZ_DealData/DataProcess.aspx?method=SaveXFLX",
            data: { data: json },
            success: function(text) {
                if (text == "") {
                    alert("保存成功!");
