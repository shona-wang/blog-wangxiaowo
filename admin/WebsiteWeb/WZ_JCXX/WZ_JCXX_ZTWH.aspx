<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WZ_JCXX_ZTWH.aspx.cs" Inherits="WZ_JCXX_WZ_JCXX_ZTWH" %>
   ...
   <!--按钮菜单功能-->
            ...
            <table style="width:100%;">
                <tr>
                    <td style="white-space:nowrap;">
                        <label for="textbox1$text">专题名称</label>
                        <input id="key" class="mini-textbox" emptyText="请输入专题名称" style="width:150px;" onenter="onKeyEnter"/>
        ...
        <div class="mini-fit" >
            <div id="dept_grid" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true" 
                url="../WZ_DealData/DataProcess.aspx?method=ZTLoad"  idfield="ID" allowcelledit="false" allowcellselect="true" multiSelect="false" emptyText="数据为空，<a href='javascript:newRow()'>增加一条</a>" showEmptyText="true">
                <div property="columns">
                   ...
                   <div field="ZTMC" width="100" headerAlign="center" >专题名称<input property="editor" class="mini-textbox" name="editor1" id="editor1" style="width:100%;" /></div>
                   <div field="SFYC" width="100" headerAlign="center" visible="false">是否删除</div>
...
<script type="text/javascript">
    ...
    function search() {
        var ztmc = mini.get("key").getValue();
        dept_grid.load({ ztmc: ztmc });
    }
    ...
    function delRow(row_uid) {
        ...
        if (row) {
            if (confirm("确定删除此记录？")) {
                ...
                $.ajax({
                    url: "../WZ_DealData/DataProcess.aspx?method=DeleteZT&ID=" + row.ID,
    ...
    function updateRow(row_uid) {
        ...
        $.ajax({
            url: "../WZ_DealData/DataProcess.aspx?method=SaveZT",
            data: { data: json },
            success: function(text) {
                if (text == "") {
                    alert("保存成功!");
