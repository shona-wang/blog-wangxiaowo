...
public partial class WZ_JCXX_upload1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //找到目标文件对象
        HttpPostedFile uploadFile = Request.Files["Fdata1"];
        System.IO.FileInfo myfile = new FileInfo(uploadFile.FileName);
        string filename = "TP" + DateTime.Now.ToString("yyyyMMddhhmmss") + myfile.Extension;
        // 如果有文件, 则保存到一个地址
