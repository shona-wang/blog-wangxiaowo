<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WZ_JCXX_LJLBWH.aspx.cs" Inherits="WZ_JCXX_WZ_JCXX_LJLBWH" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>友情链接类别维护</title>
   ...
   <!--按钮菜单功能-->
            ...
            <table style="width:100%;">
                <tr>
                    <td style="white-space:nowrap;">
                        <label for="textbox1$text">链接类别名称</label>
                        <input id="key" class="mini-textbox" emptyText="请输入链接类别名称" style="width:150px;" onenter="onKeyEnter"/>
        ...
        <div class="mini-fit" >
            <div id="dept_grid" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true" 
                url="../WZ_DealData/DataProcess.aspx?method=LJLBLoad"  idfield="FLBH" allowcelledit="false" allowcellselect="true" multiSelect="false" emptyText="数据为空，<a href='javascript:newRow()'>增加一条</a>" showEmptyText="true">
                <div property="columns">
                   <div type="checkcolumn"></div>
                   <div type="indexcolumn"  style="width:6px;" headerAlign="center">序号</div>      
                   <div field="FLBH" width="100" headerAlign="center" visible="false" >编号</div>   
                   <div field="AccountNum" width="100" headerAlign="center" visible="false">帐套号</div>  
                   <div field="FLMC" width="100" headerAlign="center" >链接类别名称<input property="editor" class="mini-textbox" name="editor1" id="editor1" style="width:100%;" /></div>
...
<script type="text/javascript">
    ...
    function delRow(row_uid) {
        ...
        if (row) {
            if (confirm("确定删除此记录？")) {
                ...
                $.ajax({
                    url: "../WZ_DealData/DataProcess.aspx?method=DeleteLJLB&FLBH=" + row.FLBH,
    ...
    function updateRow(row_uid) {
        ...
        $.ajax({
            url: "../WZ_DealData/DataProcess.aspx?method=SaveLJLB",
            data: { data: json },
            success: function(text) {
                if (text == "") {
                    alert("保存成功!");
