<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WZ_LMQX_LMSH.aspx.cs" Inherits="WZ_LMQX_WZ_LMQX_LMSH" %>
 ...
 <div class="mini-toolbar" style="padding: 2px; border-top: 0; border-left: 0; border-right: 0;">
    ...
    <div class="mini-splitter" style="width:100%;height:94%;">
        <div size="20%" showCollapseButton="true" style="padding:5px;">
            <div class="mini-fit" >
                <div id="grid1" class="mini-datagrid" style="width:100%;height:100%;" borderStyle="border:0;" url="../WZ_DealData/DataProcess.aspx?method=GetRYInfo" multiSelect="false"  idfield="YHM" onrowclick="rowclick1" sizeList=[50,100,300,500] pagesize="50">
                    <div property="columns">   
                       ...
                       <%-- <div field="AccountNum" width="120" headerAlign="center" allowSort="true" visible="false">AccountNum</div>      --%>
                        ...
                        <div field="XX" width="120" headerAlign="center" allowSort="true" >登录人员</div>      
                    </div>
                </div>  
            </div> 
        </div> 
            <div class="mini-fit">
                ...
                <ul id="tree1" class="mini-tree" url="../WZ_DealData/DataProcess.aspx?method=LoadLMTree_NRSHGL" style="width:100%;height:100%;padding:5px;" showTreeIcon="true" resultAsTree="false" 
                textField="LMMC"  idField="LMBH" parentField="FLMBH" 
                expandOnLoad="0" allowDrag="false" allowDrop="false" allowLeafDropIn="false" 
                showCheckBox="true" >
                </ul>
            </div>            
    </div>
...
<script type="text/javascript">
    ...
    function rowclick1(e) {
        ...
        var yhm = data.YHM;
        if (yhm) {
            var url = "../WZ_DealData/DataProcess.aspx?method=LoadLMSHQXTree&yhm=" + yhm;
            tree.load(url);
        }
    }
    /*--按钮事件--*/
    function saveNodeQX() {
        ...
        $.ajax({
            url: "../WZ_DealData/DataProcess.aspx?method=SaveLMSHQX",
