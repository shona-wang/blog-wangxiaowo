<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WZ_NRGL_HZCX.aspx.cs" Inherits="WZ_NRGL_WZ_NRGL_HZCX" %>
     ...
     <!--按钮菜单功能-->
        ...
        <div class="mini-fit" >
            <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
                url="../WZ_DealData/DataProcess.aspx?method=FindDocHZCX"  idfield="AccountNum,XWBH" allowcelledit="true" allowcellselect="true" multiSelect="false" sizeList=[50,100,300,500] pagesize="50">
                <div property="columns">
                    ...
                    <div field="XWZBT" width="120" headerAlign="center" allowSort="true">新闻主标题</div>
                    ...
                    <div field="XWFBZ" width="120" headerAlign="center" allowSort="true">新闻发布者</div>
...
<script type="text/javascript">
    ...
    function onActionRenderer(e) {
        ...
        //            +
        var s = ' <a class="Edit_Button" href="javascript:lookRow(\'' + uid + '\')" >预览</a>';
    ...
    function lookRow(row_uid) {
        ...
        mini.open({
        url: "../WebsiteWeb/WZ_NRGL/WZ_NRGL_CK.aspx",
            title: "预览", width: 860, height: 600,
            onload: function() {
                var iframe = this.getIFrameEl();
