<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WZ_NRGL_WTG.aspx.cs" Inherits="WZ_NRGL_WZ_NRGL_WTG" %>
     ...
     <!--按钮菜单功能-->
        ...
        <div class="mini-fit" >
            <div id="grid" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
                url="../WZ_DealData/DataProcess.aspx?method=FindWTGDoc"  idfield="AccountNum,XWBH" allowcelledit="true" allowcellselect="true" multiSelect="false" >
                <div property="columns">
                    ...
                    <div field="XWBH" width="120" headerAlign="center" allowSort="true" visible="false">编号</div>
