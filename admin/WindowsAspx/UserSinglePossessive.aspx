<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserSinglePossessive.aspx.cs"
    Inherits="WindowsAspx_UserSinglePossessive" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>用户单选-所有用户</title>
...
<body>
    ...
    <div class="mini-fit">
        <div id="grid1" class="mini-datagrid" style="width: 100%; height: 100%;" idfield="yhm"
            ...
            url="AspxDate.aspx?method=SearchEmployeesPossessive">
