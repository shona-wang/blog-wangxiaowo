<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Positiion_Edit.aspx.cs" Inherits="WindowsAspx_Positiion_Edit" %>
...
<script type="text/javascript" language="javascript">
    ...
    function SaveData(e) {
        ...
        $.ajax({
            url: "AspxDate.aspx?method=SavePositiion",
            data: { data: json },
            cache: false,
            type: "post",
    ...
    function SetData(data) {
        if (data.action == "Edit") {
            ...
            $.ajax({
                url: "AspxDate.aspx?method=Table37_Where&ZWID=" + data.zwid,
                cache: false,
                success: function(text) {
