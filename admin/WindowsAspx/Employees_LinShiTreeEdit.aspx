<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employees_LinShiTreeEdit.aspx.cs" Inherits="WindowsAspx_Employees_LinShiTreeEdit" %>
 ...
 <br />
    <table style="width: 681px;">
       <tr>
          ...
          <td class="style3" style="text-align: right">名称:</td>
          <td>
       ...
       <tr>
          <td colspan="4" style=" text-align:center">
              <a class="mini-button" iconcls="icon-save" onclick="SaveData">保存</a> <a class="mini-button"
                ...
                <input name="qt" class="mini-hidden"/>
                <input name="wz" class="mini-hidden"/>
                <input name="lxr" class="mini-hidden"/>
                <input name="dh" class="mini-hidden"/>
                <input name="BM" class="mini-hidden"/>
                <input name="zyyw" class="mini-hidden"/>
          </td>
       </tr>
    </table>
    </form>
